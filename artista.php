...
<body>
    <div class="container">
        ...
        <div class="tabla">
            <h2>Listado de Artistas de la base de datos</h2>
            <br>
            <?php 
                $conexionOracle = oci_connect("antonio", "5172", "localhost/orcl");
                    ...
                    $stid = oci_parse($conexionOracle, 'SELECT * FROM artista');
                    if (!$stid) {
                    ...
                    print "<th>DNI</th><th>Nombre Artístico</th><th>Nombre</th><th>Apellidos</th><th>Ciudad Natal</th><th>Télefono</th><th>Fecha de nacimiento</th>\n";
