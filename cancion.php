...
<body>
    <div class="container">
        ...
        <div class="tabla">
            <h2>Listado de Canciones de la base de datos</h2>
            <br>
            <?php 
                $conexionOracle = oci_connect("antonio", "5172", "localhost/orcl");
                    ...
                    $stid = oci_parse($conexionOracle, 'SELECT * FROM cancion');
                    if (!$stid) {
                    ...
                    print "<th>Título</th><th>Artista</th><th>Compositor</th><th>Nombre del álbum</th><th>Género</th><th>Duración</th>\n";
